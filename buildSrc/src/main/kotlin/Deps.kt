object Deps {
    ...
    object Facebook {
        const val Facebook = "com.facebook.android:facebook-android-sdk:16.0.0"
    }

    object Gms {
        const val IDENTIFIER = "com.google.android.gms:play-services-ads-identifier:17.0.0"
    }

    object Appsflyer {
        const val INSTAL_REFFER = "com.android.installreferrer:installreferrer:2.2"
        const val APPSFLYER = "com.appsflyer:af-android-sdk:6.9.0"
    }
